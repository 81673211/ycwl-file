...
public class FileResponseCode extends ResponseCode {
    ...
    public static final ResponseCode FILE_EXTENSION_ILLEGAL =
            new ResponseCode("01004", "上传的文件扩展名不合规，扩展名只能是JPG、JPEG、PNG、MP4且不能没有");
    public static final ResponseCode UPLOAD_FILE_ERROR = new ResponseCode("01005", "上传文件失败，请联系IT");
    public static final ResponseCode MKDIR_ERROR = new ResponseCode("01006", "文件目录创建失败，请联系IT");
